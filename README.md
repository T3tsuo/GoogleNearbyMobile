...
Purpose: The app will load the saved locations file to check when a person is arriving or leaving the location you set in the file and then will push a notification to notifying the user.
